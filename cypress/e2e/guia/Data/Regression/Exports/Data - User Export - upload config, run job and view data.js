...
describe('User Export - import preconfig, run the job and view data', () => {
  it('should able to import report config, run job and view data', () => {
    ...
    cy.get(DataImportsMenu.getUploadField()).attachFile(generalTestData.uploadExportFilePath + generalTestData.userReportFile)
    ...
    cy.get(DataReportPage.getReportDataColumnTitle()).should('be.visible').contains('FirstName')
