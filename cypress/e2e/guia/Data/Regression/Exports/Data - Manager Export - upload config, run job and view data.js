...
describe('Manager Export - import preconfig, run the job and view data', () => {
  it('should able to import report config, run job and view data', () => {
    ...
    cy.get(DataImportsMenu.getUploadField()).attachFile(generalTestData.uploadExportFilePath + generalTestData.managerReportFile)
    ...
    cy.get(DataReportPage.getReportDataColumnTitle()).should('be.visible').contains('Manager')
