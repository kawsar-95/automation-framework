...
describe('C1936 AUT-495 GUIA-Story - Acceptance Test - NLE-2217 - Groups Report - Mass Action Message Groups', function () {
    beforeEach(() => {
    ...
    it(`Verify that the [Message Groups] button appears in the side bar when a group in the group report page is selected`, () => {
        arDashboardPage.getGroupsReport()

        // Search  Group by name
        arGroupAddEditPage.AddFilter('Name', 'Contains', groupDetails.groupName)
        // Filtering out second group name 
        ...
        cy.get(arGroupAddEditPage.getAddEditMenuActionsByName('Message Groups')).should('have.attr', 'aria-disabled', 'false')
    ...
    after('should allow admin to delete a group', () => {
        ...
        cy.wrap(arGroupAddEditPage.WaitForElementStateToChange(arGroupAddEditPage.getAddEditMenuActionsByName('Delete Group')))
        ...
        //Deleting Second Group
        arDashboardPage.getGroupsReport()

        // Search and delete Groups
        arGroupAddEditPage.AddFilter('Name', 'Contains', groupDetails.groupName2)
        cy.get(ARDashboardPage.getTableCellRecord()).should('contain', groupDetails.groupName2).click()
