...
describe('C990 AUT-191, AR - OC - Publish Confirmation Modal for all Course Types (cloned)', function(){
    beforeEach(() => {
    ...
    it('Edit Online Course', () => {
        ...
        //Set enrollment rules
        ARCourseSettingsEnrollmentRulesModule.AddEnrollmentRule('Auto', 'Username', 'Contains', users.learner01.learner_01_username, null) 
