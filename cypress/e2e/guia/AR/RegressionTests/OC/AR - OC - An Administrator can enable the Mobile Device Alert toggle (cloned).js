...
describe("C909 - AR - Regress -An Administrator can enable the Mobile Device Alert toggle (cloned)", () => {
    ...
    it("Admin can publish a course by Turning on Mobile Device Alert toggle", () => {
        ...
        cy.get(AROCAddEditPage.getSyllabusMobileDeviceAlertToggle() + AROCAddEditPage.getToggleDisabled()).click()
...
describe("C909 - AR - Regress -An Administrator can disable the Mobile Device Alert toggle (cloned)", () => {
