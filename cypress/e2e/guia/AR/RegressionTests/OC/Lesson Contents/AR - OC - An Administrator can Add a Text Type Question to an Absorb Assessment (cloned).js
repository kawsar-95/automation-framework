...
describe('C774 AUT-206, AR - OC - An Administrator can Add a Text Type Question to an Absorb Assessment (cloned)', function () {
    beforeEach(() => {
    ...
    it('Create Online Course with Learning Assesement', () =>{
        ...
        // Question text field allows up to 4000 characters
        cy.get(ARAddObjectLessonModal.getQuestionNameTextBox()).invoke('text', ARDashboardPage.getLongString(4000)).type('a', {force: true})
        cy.get(ARAddObjectLessonModal.getQuestionNameErrorMsg()).should('contain', miscData.char_4000_error)
        // Enter Valid Name
    ...
    it('Edit Online Course and edit Question', () =>{
        ...
        // 4. Ensure ability to edit Questions
    ...
    it('Edit Online Course and Delete Question', () =>{
        ...
        // 5. Ensure ability to delete a text type question
