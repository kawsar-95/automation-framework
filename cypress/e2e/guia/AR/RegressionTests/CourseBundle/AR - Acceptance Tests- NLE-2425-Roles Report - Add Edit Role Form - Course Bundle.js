...
describe('C1970 AUT-523 Acceptance Tests- NLE-2425-Roles Report - Add/Edit Role Form - Course Bundle', () => {
    ...
    it(`Login as  ${userDetails.username} in AE and verify that 'Add Course Bundle' is not available`, () => {
        ...
        //Asserting page 
        cy.get(ARDashboardPage.getPageHeaderTitle()).should('have.text', 'Courses')
        //Filter out a course bundle course
        ARCoursesPage.AddFilter('Name', 'Equals', courses.cb_filter_01_name)
    ...
    it(` verifying ${userDetails.username} have access to 'Add Course Bundle' and other features`, () => {
        ...
        cy.get(ARDashboardPage.getAddEditMenuActionsByName('Add Course Bundle')).should('have.attr', 'aria-disabled', 'false')
        ...
        cy.get(ARDashboardPage.getWaitSpinner(), { timeout: 150000 }).should('not.exist')
        cy.get(ARDashboardPage.getPageHeaderTitle()).should('have.text', 'Add Course Bundle')
