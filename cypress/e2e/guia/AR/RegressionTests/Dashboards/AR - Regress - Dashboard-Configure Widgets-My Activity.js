...
const widgetNumber = 4;

describe("C6350, C7259 - AR - Regress - Dashboard - Configure Widgets - Add Widget - My Activities", function () {
    ...
    it("Add Widget - My Activities Widget Back Button Pressed", function () {
        ...
        ARDashboardPage.addWidgetWithoutConfirmation(dashboardDetails.myActivity, widgetNumber)
        ...
        //Add Widget ( My Activities Widget)
        ARDashboardPage.addWidget(dashboardDetails.myActivity, widgetNumber)
        // General Section - Enter Title for the My Activities widget
