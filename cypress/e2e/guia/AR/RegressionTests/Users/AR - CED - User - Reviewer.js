...
describe('AR - CED - User - Reviewer', () => {
    ...
    it('Verify an Admin can Create a Reviewer Type User', () => {
        //Add new user
        ...
        //Turn Learner toggle OFF and turn Reviewer toggle ON
        ...
        cy.get(ARUserAddEditPage.getElementByDataNameAttribute(ARUserAddEditPage.getReviewerToggleContainer()) + ' ' + ARUserAddEditPage.getToggleDisabled()).click()

        //Verify toggle ON Message
        cy.get(ARUserAddEditPage.getToggleDescriptionBanner()).should('contain', ARUserAddEditPage.getReviewerToggleOnMsg())
        ...
        cy.get(ARUserAddEditPage.getCountryDDownOpt()).contains(ecommFields.country).click()
        cy.get(ARUserAddEditPage.getStateProvinceDDown()).click()
        cy.get(ARUserAddEditPage.getStateProvinceDDownSearchInputTxt()).type(ecommFields.province)
        ...
        cy.get(ARUserAddEditPage.getSupervisorDDownSearchInputTxt()).type(employmentDetailsSectionFields.supervisor)
    ...
    it('Verify Reviewer User Creation Persists, Edit Reviewer', () => {
        ...
        cy.get(ARUserAddEditPage.getElementByDataNameAttribute(ARUserAddEditPage.getReviewerToggleContainer()) + ' ' + ARUserAddEditPage.getToggleStatus())
            .should('have.attr', 'aria-checked', 'true')
        ...
        cy.get(ARUserAddEditPage.getLanguageDDown()).should('have.text', detailsSectionFields.language2)
    ...
    it('Verify Reviewer User Edits Persist', () => {
        ...
        cy.get(ARUserAddEditPage.getCountryDDownSearchInputTxt()).eq(0).type('{enter}')
        cy.get(ARUserAddEditPage.getCountryDDown()).should('contain.text', ecommFields.country2)
        cy.get(ARUserAddEditPage.getStateProvinceDDown()).click()
        cy.get(ARUserAddEditPage.getStateProvinceDDownSearchInputTxt()).type(ecommFields.province2)
        cy.get(ARUserAddEditPage.getStateProvinceDDownSearchInputTxt()).type('{enter}')
    ...
    it('Verify Reviewer User can be Deleted', () => {
