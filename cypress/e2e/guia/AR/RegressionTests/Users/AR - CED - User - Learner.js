...
import {userDetails, ecommFields, employmentDetailsSectionFields, detailsSectionFields}  from '../../../../../../helpers/TestData/users/UserDetails'
import { departments } from '../../../../../../helpers/TestData/Department/departments'
import ARDashboardPage from '../../../../../../helpers/AR/pageObjects/Dashboard/ARDashboardPage'

describe('AR - CED - User - Learner', () => {
    ...
    it('Verify an Admin can Create a Learner Type User', () => {
        //Add new user
        ...
        cy.get(ARUserAddEditPage.getToggleDescriptionBanner()).should('contain', ARUserAddEditPage.getLearnerToggleOnMsg())
    ...
    it('Verify Learner Type User Creation Persists, Edit Learner', () => {
        ...
        cy.get(ARUserAddEditPage.getStateProvinceDDownOpt()).contains(ecommFields.province2).click({force : true})
    ...
    it('Verify Learner Type Edits Persist', () => {
    ...
    it('Verify Learner Type User can be Deleted', () => {
