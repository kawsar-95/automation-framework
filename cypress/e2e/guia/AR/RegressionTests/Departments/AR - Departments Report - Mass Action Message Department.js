...
describe('C1896 AUT-464, AR - Departments Report - Mass Action Message Department', () => {
    beforeEach(() => {
        cy.apiLoginWithSession(users.sysAdmin.admin_sys_01_username, users.sysAdmin.admin_sys_01_password, '/admin')
        arDashboardPage.getDepartmentsReport()
    })

    it('Verify Message Department and Cancel the compose', () => {
        ...
        // 2. Mass action button "Message Department" should appear
        cy.get(arDepartmentsAddEditPage.getAddEditMenuActionsByName('Message Department')).should('be.visible').click()
        ...
        ARComposeMessage.verifyRecipientDepartmentTypeRadioBtn('Send to people in these departments only', 'true')

        // selecting the [Cancel] from the message department page
    ...
    it('Verify Message Department and Send the Message', () => {
        arDepartmentsAddEditPage.AddFilter('Name', 'Starts With', departments.Dept_B_name)
        arDepartmentsAddEditPage.selectTableCellRecord(departments.Dept_B_name, 2)
        arDepartmentsAddEditPage.AddFilter('Name', 'Starts With', departments.Dept_C_name)
        arDepartmentsAddEditPage.selectTableCellRecord(departments.Dept_C_name, 2)
        ...
        // selecting the [Send] from the message department page
