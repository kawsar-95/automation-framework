...
describe('C866 - AUT-287 - un-enroll a user from a Course (course enrollments report) (cloned) - CourseBundle course', () => {
    before("create a new user and an online course and enroll that user to the course", () => {
        ...
        // Enroll User 
        AREnrollUsersPage.getEnrollUserByCourseAndUsername([courses.cb_filter_01_name], [userDetails.username])
    ...
    it("Un-enroll Button Appear's in the Course Enrollments report when a single user is selected" , () =>{
        ...
        ARCourseActivityReportPage.ChooseAddFilter(courses.cb_filter_01_name)
