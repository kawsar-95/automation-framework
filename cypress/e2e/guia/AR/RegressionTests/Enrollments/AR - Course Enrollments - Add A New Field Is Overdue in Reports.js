...
describe('C7305 AUT-689, AR - User Enrollments - Add A New Field Is Overdue in Reports', () => {
    ...
    it('See Enrollments for a course that has a due date from Course Enrollments', () => {
        arDashboardPage.getCourseEnrollmentReport()
        arDashboardPage.EnrollmentPageFilter(ocDetails.courseName)
        ...
        cy.get(AREnrollUsersPage.getTableCellName(4)).contains(userDetails.username).click()
        ...
        cy.get(arDashboardPage.getPageHeaderTitle()).should('be.visible').and('contain', 'Course Enrollments')
