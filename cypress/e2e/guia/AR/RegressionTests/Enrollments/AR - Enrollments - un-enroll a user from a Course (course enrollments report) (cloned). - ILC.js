...
describe('C866 - AUT-287 - un-enroll a user from a Course (course enrollments report) (cloned) - ILC course', () => {
    ...
    it("Un-enroll Button Appear's in the Course Enrollments report when a single user is selected" , () =>{
        ...
        ARCourseActivityReportPage.ChooseAddFilter(ilcDetails.courseName)
