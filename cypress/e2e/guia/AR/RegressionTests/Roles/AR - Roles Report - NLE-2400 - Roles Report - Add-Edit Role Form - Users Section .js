...
describe('C1945 AUT-504 GUIA-Story - NLE-2400 - Roles Report - Add/Edit Role Form - Users Section', () => {
    it("create a Custom Roles and press cancel on the modal", () => {
        ...
        ARRolesAddEditPage.getSectionExpandibleBtn('Users').should('have.attr', 'aria-expanded', 'true')
        //Clicking on the Users expanded button to make it collapse 
        ARRolesAddEditPage.getSectionExpandibleBtn('Users').click()
        //Asserting the it has collapsed
        ARRolesAddEditPage.getSectionExpandibleBtn('Users').should('have.attr', 'aria-expanded', 'false')
