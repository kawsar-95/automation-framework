...
describe('C1949 AUT-506 GUIA-Story - Acceptance Test - NLE-2397 - Roles Report - Add/Edit Role Form - E-Commerce Section- edit summary', () => {
	...
	it(`Login as  ${userDetails.username} in AE and verify that 'Ecommerce Transaction' is  available`, () => {
		...
		ARDashboardPage.getEcommerceTransactionReport()
		//Asserting page 
		cy.get(ARDashboardPage.getA5PageHeaderTitle()).should('have.text', menuitems.TRANSACTIONS)
		cy.get(ARDashboardPage.getA5DashboardBtn()).click()
		cy.get(ARDashboardPage.getWaitSpinner(), { timeout: 150000 }).should('not.exist')
		//Go to Ecommerce page
		ARDashboardPage.getECommerceTransactionDetailsReport()
		//Asserting page 
		cy.get(ARDashboardPage.getA5PageHeaderTitle()).should('have.text', menuitems.TRANSACTION_DETAILS)
		cy.get(ARDashboardPage.getA5DashboardBtn()).click()
		cy.get(ARDashboardPage.getWaitSpinner(), { timeout: 150000 }).should('not.exist')
	...
	it(` verifying ${userDetails.username2} have access to 'Generated Reports' and other features`, () => {
		...
		ARDashboardPage.getECommerceCouponsReport()
		//Asserting page 
		cy.get(ARDashboardPage.getA5PageHeaderTitle()).should('have.text', menuitems.COUPONS)
