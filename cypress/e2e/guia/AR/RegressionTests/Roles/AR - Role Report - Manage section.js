...
describe('C1948 AUT-505 GUIA-Story - Acceptance Tests-NLE-2394-Roles Report - Add/Edit Role Form - Manage Section', () => {
   ...
   it(`Login as  ${userDetails.username} in AE and verify that 'Message Templates' is available but FAQS , Translations  , Files are not available`, () => {
      ...
      ARDashboardPage.getMediumWait()
      cy.get(ARDashboardPage.getWaitSpinner()).should('not.exist')
      cy.get(ARDashboardPage.getElementByAriaLabelAttribute(ARDashboardPage.getARLeftMenuByLabel(menuItems.SETUP))).click()
      cy.get(ARDashboardPage.getWaitSpinner()).should('not.exist')
