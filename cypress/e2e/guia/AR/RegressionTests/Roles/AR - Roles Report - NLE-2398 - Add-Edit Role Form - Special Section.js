...
import { rolesDetails, defaultRoleNames } from "../../../../../../helpers/TestData/Roles/rolesDetails"
...
describe('C1953 AUT-510 GUIA-Story - NLE-2398 - Roles Report - Add/Edit Role Form - Special Section', () => {
   it("create an admin user with Custom Roles", () => {
      ...
      cy.get(ARDashboardPage.getCurrentUserLabel()).should('contain.text', users.blatAdmin.admin_blat_01_fullname)
   ...
   it(` Login as blatAdmin and View Role of Default Role Names`, () => {
      cy.apiLoginWithSession(users.blatAdmin.admin_blat_01_username, users.blatAdmin.admin_blat_01_password, '/admin')
      ...
      cy.get(ARDashboardPage.getPageHeaderTitle()).should('have.text', 'Roles')
      cy.wrap(ARDashboardPage.WaitForElementStateToChange(ARDashboardPage.getAddEditMenuActionsByName('Add Role'), 1000))
      ARRolesAddEditPage.AssertDefaultRoles([defaultRoleNames.ADMIN, defaultRoleNames.BILLING, defaultRoleNames.CREATE_EDITOR, defaultRoleNames.INSTRUCTOR
         , defaultRoleNames.INTERNAL_SALES_ADMIN, defaultRoleNames.MULTIPLE_CLIENT_ADMIN, defaultRoleNames.REPORTER, defaultRoleNames.SYSTEM_ADMIN])
