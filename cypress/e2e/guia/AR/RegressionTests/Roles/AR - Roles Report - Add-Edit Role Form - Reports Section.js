...
describe('C1940 AUT-499GUIA-Story - Acceptance Test - NLE-2385 - Roles Report - Add/Edit Role Form - Reports Section', () => {
    it("create an admin user with Custom Roles", () => {
        ...
        ARRolesAddEditPage.getSelectCheckboxBySectionNameAndIndexNumber('reports', 0, 'Course Activity')
    ...
    it(`Login as  ${userDetails.username} in AE and verify that 'Course Activity Report' is  available`, () => {
        ...
        //Asserting page 
        cy.get(ARDashboardPage.getPageHeaderTitle()).should('have.text', 'Course Activity')
    
        cy.logoutAdmin()

    })

    it(`Editing ${rolesDetails.roleName} to ADD modify Curricula Activity report Permission`, () => {
        cy.apiLoginWithSession(users.sysAdmin.admin_sys_01_username, users.sysAdmin.admin_sys_01_password, '/admin')
    ...
    it(` verifying ${userDetails.username2} have access to 'Curricula Activity Report' and other features`, () => {
        ...
        //Asserting page 
        cy.get(ARDashboardPage.getPageHeaderTitle()).should('have.text', 'Curricula Activity')
