...
describe('C1941 AUT-500 GUIA-Story - NLE-2385 - Roles Report - Add/Edit Role Form - Reports Section', () => {
    it("create a Custom Roles and press cancel on the modal", () => {
        ...
        ARRolesAddEditPage.getSectionExpandibleBtn('Reports').should('have.attr', 'aria-expanded', 'true')
        //Clicking on the Reports expanded button to make it collapse 
        ARRolesAddEditPage.getSectionExpandibleBtn('Reports').click()
        //Asserting the it has collapsed
        ARRolesAddEditPage.getSectionExpandibleBtn('Reports').should('have.attr', 'aria-expanded', 'false')
