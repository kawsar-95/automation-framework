...
import arCourseApprovalReportPage, { getSuccessMsg } from '../../../../../../helpers/AR/pageObjects/Reports/ARCourseApprovalReportPage'

describe('C7294, AR - AE Regression - Course Approval - Approve', function(){
    after(function() {
    ...
    it("Filter the saved course in Course Approval Report ",()=>{
        ...
        arCourseApprovalReportPage.getA5AddEditMenuActionsByNameThenClick('Approve')
        arCourseApprovalReportPage.getMediumWait()

        // Verify Messege displayed
        cy.get(arCourseApprovalReportPage.getSuccessText()).should('have.text', getSuccessMsg)
    })
})