...
describe('C7305 AUT-689, AR - Reports - Course Activity - Add A New Field Is Overdue in Reports', () => {
    ...
    it('See Enrollments for a course that has a due date from Course Activity', () => {
        ...
        cy.wrap(AREnrollUsersPage.WaitForElementStateToChange(AREnrollUsersPage.getAddEditMenuActionsByName('Edit Activity'), 1000))
        cy.get(AREnrollUsersPage.getAddEditMenuActionsByName('Edit Activity')).click()
        ...
        AREditActivityPage.getSelectDate(AREditActivityPage.getPastDate(5))
        ...
        cy.get(arDashboardPage.getPageHeaderTitle()).should('be.visible').and('contain', 'Course Activity')
