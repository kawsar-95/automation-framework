...
describe('C7394 - AR - Regression - External Training - Decline an External Training (cloned)', function(){
    ...
    it('Status should be displayed Decline', function(){
        // Select first row
        cy.get(ARExternalTrainingPage.getExternalTrainingFirstResultItem()).click()
        ARExternalTrainingPage.getShortWait()
        cy.get(ARExternalTrainingPage.getDeclineButton()).should('exist')
        cy.get(ARExternalTrainingPage.getDeclineButton()).click()
        ARExternalTrainingPage.getShortWait()
        cy.get(ARExternalTrainingPage.getExternalTrainingFirstResultItemStatus()).should('contain.text','Decline')
    })
})
