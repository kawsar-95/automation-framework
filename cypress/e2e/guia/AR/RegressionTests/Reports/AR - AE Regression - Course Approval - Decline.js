...
import arCourseApprovalReportPage, { getDeclineMsg } from '../../../../../../helpers/AR/pageObjects/Reports/ARCourseApprovalReportPage'

describe('C7295, AR - AE Regression - Course Approval - Decline', function(){
    after(function() {
    ...
    it("Filter the saved course in Course Approval Report ",()=>{
        ...
        arCourseApprovalReportPage.getA5AddEditMenuActionsByNameThenClick('Decline')
        arCourseApprovalReportPage.getMediumWait()

        // Verify Messege displayed
        cy.get(arCourseApprovalReportPage.getSuccessText()).should('have.text', getDeclineMsg)
    })
})