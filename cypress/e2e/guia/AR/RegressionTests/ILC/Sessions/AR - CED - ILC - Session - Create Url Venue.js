...
describe('AR - CED - ILC - Session - Create Url Venue', function(){
    ...
    it('Verify Url Venue can be Created when Adding Session to ILC', () => {
        ...
        cy.get(ARILCAddEditPage.getVenueTypeDDownOpt()).contains(venueTypes.url).click()

        //Enter valid name
        cy.get(ARILCAddEditPage.getAddVenueNameTxtF()).type(`${venueDetails.venueName} - ${venueTypes.url}`)
    ...
    it('Verify Venue Details Persist, Delete Venue', () => {
        ...
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.url}`)
