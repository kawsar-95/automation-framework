...
describe('AR - CED - ILC - Session - Create WebEx Venue', function(){
    ...
    it('Verify WebEx Venue can be Created when Adding Session to ILC', () => {
        ...
        cy.get(ARILCAddEditPage.getVenueTypeDDownOpt()).contains(venueTypes.webEx).click()

        //Enter valid name
        cy.get(ARILCAddEditPage.getAddVenueNameTxtF()).type(`${venueDetails.venueName} - ${venueTypes.webEx}`)
    ...
    it('Verify Venue Details Persist, Delete Venue', () => {
        ...
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.webEx}`)
