...
describe('AR - CED - Venues - WebEx', function(){
    ...
    it(`Verify ${venueTypes.webEx} Venue can be Created`, () => {
        ...
        cy.get(ARVenueAddEditPage.getTypeDDownOpt()).contains(venueTypes.webEx).click()
        ...
        //Enter valid name
        cy.get(ARVenueAddEditPage.getNameTxtF()).type(`${venueDetails.venueName} - ${venueTypes.webEx}`)
    ...
    it(`Verify ${venueTypes.webEx} Venue Values Persist, Edit Venue`, () => {
        //Filter for and edit venue
        ARVenueAddEditPage.AddFilter('Name', 'Contains', `${venueDetails.venueName} - ${venueTypes.webEx}`)
        ARVenueAddEditPage.selectTableCellRecord(`${venueDetails.venueName} - ${venueTypes.webEx}`)
        ...
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.webEx}`).type(commonDetails.appendText)
    ...
    it(`Verify ${venueTypes.webEx} Venue Edits Persist`, () => {
        //Filter for and edit venue
        ARVenueAddEditPage.AddFilter('Name', 'Contains', `${venueDetails.venueName} - ${venueTypes.webEx}${commonDetails.appendText}`)
        ARVenueAddEditPage.selectTableCellRecord(`${venueDetails.venueName} - ${venueTypes.webEx}${commonDetails.appendText}`)
        ARVenueAddEditPage.WaitForElementStateToChange(ARVenueAddEditPage.getAddEditMenuActionsByName('Edit Venue'))
        cy.get(ARVenueAddEditPage.getAddEditMenuActionsByName('Edit Venue')).click()
        ARVenueAddEditPage.getLShortWait()

        //Verify values persisted
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.webEx}${commonDetails.appendText}`)
    ...
    it(`Verify ${venueTypes.webEx} Venue Can Be Deleted`, () => {
