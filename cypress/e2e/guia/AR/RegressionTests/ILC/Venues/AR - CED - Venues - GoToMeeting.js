...
describe('AR - CED - Venues - GoToMeeting', function(){
    ...
    it(`Verify ${venueTypes.goToMeeting} Venue can be Created`, () => {
        ...
        cy.get(ARVenueAddEditPage.getTypeDDownOpt()).contains(venueTypes.goToMeeting).click()
        ...
        //Enter valid name
        cy.get(ARVenueAddEditPage.getNameTxtF()).type(`${venueDetails.venueName} - ${venueTypes.goToMeeting}`)
    ...
    it(`Verify ${venueTypes.goToMeeting} Venue Values Persist, Edit Venue`, () => {
        //Filter for and edit venue
        ARVenueAddEditPage.AddFilter('Name', 'Contains', `${venueDetails.venueName} - ${venueTypes.goToMeeting}`)
        ARVenueAddEditPage.selectTableCellRecord(`${venueDetails.venueName} - ${venueTypes.goToMeeting}`)
        ...
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.goToMeeting}`).type(commonDetails.appendText)
    ...
    it(`Verify ${venueTypes.goToMeeting} Venue Edits Persist`, () => {
        //Filter for and edit venue
        ARVenueAddEditPage.AddFilter('Name', 'Contains', `${venueDetails.venueName} - ${venueTypes.goToMeeting}${commonDetails.appendText}`)
        ARVenueAddEditPage.selectTableCellRecord(`${venueDetails.venueName} - ${venueTypes.goToMeeting}${commonDetails.appendText}`)
        ARVenueAddEditPage.WaitForElementStateToChange(ARVenueAddEditPage.getAddEditMenuActionsByName('Edit Venue'))
        cy.get(ARVenueAddEditPage.getAddEditMenuActionsByName('Edit Venue')).click()
        ARVenueAddEditPage.getLShortWait()

        //Verify values persisted
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.goToMeeting}${commonDetails.appendText}`)
    ...
    it(`Verify ${venueTypes.goToMeeting} Venue Can Be Deleted`, () => {
