...
describe('AR - CED - Venues - Url', function(){
    ...
    it(`Verify ${venueTypes.url} Venue can be Created`, () => {
        ...
        cy.get(ARVenueAddEditPage.getTypeDDownOpt()).contains(venueTypes.url).click()
        ...
        //Enter valid name
        cy.get(ARVenueAddEditPage.getNameTxtF()).type(`${venueDetails.venueName} - ${venueTypes.url}`)
    ...
    it(`Verify ${venueTypes.url} Venue Values Persist, Edit Venue`, () => {
        //Filter for and edit venue
        ARVenueAddEditPage.AddFilter('Name', 'Contains', `${venueDetails.venueName} - ${venueTypes.url}`)
        ARVenueAddEditPage.selectTableCellRecord(`${venueDetails.venueName} - ${venueTypes.url}`)
        ...
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.url}`).type(commonDetails.appendText)
    ...
    it(`Verify ${venueTypes.url} Venue Edits Persist`, () => {
        //Filter for and edit venue
        ARVenueAddEditPage.AddFilter('Name', 'Contains', `${venueDetails.venueName} - ${venueTypes.url}${commonDetails.appendText}`)
        ARVenueAddEditPage.selectTableCellRecord(`${venueDetails.venueName} - ${venueTypes.url}${commonDetails.appendText}`)
        ARVenueAddEditPage.WaitForElementStateToChange(ARVenueAddEditPage.getAddEditMenuActionsByName('Edit Venue'))
        cy.get(ARVenueAddEditPage.getAddEditMenuActionsByName('Edit Venue')).click()
        ARVenueAddEditPage.getLShortWait()

        //Verify values persisted
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.url}${commonDetails.appendText}`)
    ...
    it(`Verify ${venueTypes.url} Venue Can Be Deleted`, () => {
