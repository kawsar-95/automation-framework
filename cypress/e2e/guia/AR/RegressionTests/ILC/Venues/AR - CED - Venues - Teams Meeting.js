...
describe('AR - CED - Venues - Teams Meeting', function(){
    ...
    it(`Verify ${venueTypes.teamsMeeting} Venue can be Created`, () => {
        ...
        cy.get(ARVenueAddEditPage.getTypeDDownOpt()).contains(venueTypes.teamsMeeting).click()
        ...
        //Enter valid name
        cy.get(ARVenueAddEditPage.getNameTxtF()).type(`${venueDetails.venueName} - ${venueTypes.teamsMeeting}`)
    ...
    it(`Verify ${venueTypes.teamsMeeting} Venue Values Persist, Edit Venue`, () => {
        //Filter for and edit venue
        ARVenueAddEditPage.AddFilter('Name', 'Contains', `${venueDetails.venueName} - ${venueTypes.teamsMeeting}`)
        ARVenueAddEditPage.selectTableCellRecord(`${venueDetails.venueName} - ${venueTypes.teamsMeeting}`)
        ...
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.teamsMeeting}`).type(commonDetails.appendText)
    ...
    it(`Verify ${venueTypes.teamsMeeting} Venue Edits Persist`, () => {
        //Filter for and edit venue
        ARVenueAddEditPage.AddFilter('Name', 'Contains', `${venueDetails.venueName} - ${venueTypes.teamsMeeting}${commonDetails.appendText}`)

        ARVenueAddEditPage.selectTableCellRecord(`${venueDetails.venueName} - ${venueTypes.teamsMeeting}${commonDetails.appendText}`)
        ARVenueAddEditPage.WaitForElementStateToChange(ARVenueAddEditPage.getAddEditMenuActionsByName('Edit Venue'))
        cy.get(ARVenueAddEditPage.getAddEditMenuActionsByName('Edit Venue')).click()
        ARVenueAddEditPage.getLShortWait()

        //Verify values persisted
        cy.get(ARVenueAddEditPage.getNameTxtF()).should('have.value', `${venueDetails.venueName} - ${venueTypes.teamsMeeting}${commonDetails.appendText}`)
    ...
    it(`Verify ${venueTypes.teamsMeeting} Venue Can Be Deleted`, () => {
