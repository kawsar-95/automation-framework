...
describe('LE - Auth - Login and Logout - Valid - As Learner', function(){
    ...
    it('Login-Logout', function(){      
        cy
            ...
            .get(LEDashboardPage.getUsernameTxtF()).should('be.visible').type(users.learnerLogInOut.LEARNER_LOGINOUT_USERNAME)
            .get(LEDashboardPage.getPasswordTxtF()).should('be.visible').type(users.learnerLogInOut.LEARNER_LOGINOUT_PASSWORD)
            ...
            .wait(3000)
            .get(LEDashboardPage.getTitleforMycouses()).should('be.visible')
            //.contains('Welcome')
