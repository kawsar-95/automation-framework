...
describe('LE - Welcome Tile Private Dashboard Text Options customization', function () {
    ...
    it('Verify Welcome Tile Text Customization', () => {
        ...
        cy.get(LEManageTemplateTiles.getWelcomeTileMiddlenameoption()).should('be.visible')
        cy.get(LEManageTemplateTiles.getWelcomeTileEmailoption()).should('be.visible')
        cy.get(LEManageTemplateTiles.getWelcomeTilePhoneoption()).should('be.visible')
        cy.get(LEManageTemplateTiles.getWelcomeTileusernameoption()).should('be.visible')
