...
describe('LE - E-Comm - Existing User - Free - CURR', function(){
    ...
    it('Search for & add free CURR to cart', () => {   
    ...
    it('Verify newly purchased CURR can be started', () => { 
        LEFilterMenu.SearchForCourseByName(courses.CURR_ECOMM_FREE_COURSE_01_NAME)
        LEDashboardPage.getMediumWait()
        LEDashboardPage.getCourseCardBtnThenClick(courses.CURR_ECOMM_FREE_COURSE_01_NAME)
        cy.get(LECoursesPage.getCourseILCTitle()).should('contain', courses.CURR_ECOMM_FREE_COURSE_01_NAME)
    })
})