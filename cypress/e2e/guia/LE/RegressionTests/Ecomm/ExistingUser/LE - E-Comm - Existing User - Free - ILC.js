...
describe('LE - E-Comm - Existing User - Free - ILC', function(){
    ...
    it('Verify newly purchased ILC course can be started', () => { 
        LEFilterMenu.SearchForCourseByName(courses.ILC_ECOMM_FREE_COURSE_01_NAME)
        LEDashboardPage.getMediumWait()
        LEDashboardPage.getCourseCardBtnThenClick(courses.ILC_ECOMM_FREE_COURSE_01_NAME)
        cy.get(LECoursesPage.getCourseILCTitle()).should('contain', courses.ILC_ECOMM_FREE_COURSE_01_NAME)
    })
})