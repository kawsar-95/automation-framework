...
const CED_CURR_NAME = 'GUIA - CED - CURR - ' + timestamp;
let userID, courseID;
let extensionDays = ['2', '3', '5'];
let extensionPrices = ['20', '30', '40'];

describe('LE - E-Comm - Purchase - CURR Course Extension', function(){
    before(function() {
        //Create a new user
        ...
        cy.createCourse('Curriculum', CED_CURR_NAME)
    ...
    it('Purchase CURR and Verify Expiration Banner', () => { 
