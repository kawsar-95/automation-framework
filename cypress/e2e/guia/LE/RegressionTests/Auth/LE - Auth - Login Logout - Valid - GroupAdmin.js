...
describe('LE - Auth - Login and Logout - Valid - As GroupAdmin', function(){
    ...
    it('Login-Logout', function(){      
        cy
            ...
            .get(LEDashboardPage.getUsernameTxtF()).should('be.visible').type(users.groupAdminLogInOut.ADMIN_GROUP_LOGINOUT_USERNAME)
            .get(LEDashboardPage.getPasswordTxtF()).should('be.visible').type(users.groupAdminLogInOut.ADMIN_GROUP_LOGINOUT_PASSWORD)
