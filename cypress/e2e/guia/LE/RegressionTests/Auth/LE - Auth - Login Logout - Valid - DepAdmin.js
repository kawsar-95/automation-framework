...
describe('LE - Auth - Login and Logout - Valid - As DepAdmin', function(){
    ...
    it('Login-Logout', function(){      
        cy
            ...
            .get(LEDashboardPage.getUsernameTxtF()).should('be.visible').type(users.depAdminLogInOut.ADMIN_DEP_LOGINOUT_USERNAME)
            .get(LEDashboardPage.getPasswordTxtF()).should('be.visible').type(users.depAdminLogInOut.ADMIN_DEP_LOGINOUT_PASSWORD)
