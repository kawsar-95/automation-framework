...
describe('LE - Auth - Login and Logout - Valid - As Instructor', function(){
    ...
    it('Login-Logout', function(){      
        cy
            ...
            .get(LEDashboardPage.getUsernameTxtF()).should('be.visible').type(users.instructorLogInOut.INSTRUCTOR_LOGINOUT_USERNAME)
            .get(LEDashboardPage.getPasswordTxtF()).should('be.visible').type(users.instructorLogInOut.INSTRUCTOR_LOGINOUT_PASSWORD)
