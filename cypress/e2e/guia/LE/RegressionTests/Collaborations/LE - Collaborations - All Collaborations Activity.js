...
describe('LE - Collaborations - All Collaborations Activity', function(){
    try {
        before(function() {
        ...
        it('Verify All Collaborations Activity Page', () => {  
        ...
        it('Verify All Collaborations Activity Post Information', () => {  
            ...
            cy.get(LECollaborationsActivityPage.getPostTitle()).contains(`${collaborationDetails.posts[5]} - ${collaborationDetails.postSummary}`)
                .parents(LECollaborationsActivityPage.getPostContainer()).within(() => {
                    ...
                    cy.get(LECollaborationsActivityPage.getCollaborationActivityCardModuleName()).first().should('contain', collaborationDetails.l01Name)
                    cy.get(LECollaborationsActivityPage.getPostCollaborationName()).should('contain', collaborationNames.A_COLLABORATION_NAME)
            ...
            //Verify Clicking the Collaboration Name in a Post takes you to the Collaboration Details page
            cy.get(LECollaborationsActivityPage.getPostTitle()).contains(`${collaborationDetails.posts[5]} - ${collaborationDetails.postSummary}`)
                .parents(LECollaborationsActivityPage.getPostContainer()).within(() => {
                    cy.get(LECollaborationsActivityPage.getPostCollaborationName()).click() 
                })
    
            //Verify You can Click the back Button to go back to All Collaborations Activity
        ...
        it('Cleanup - Delete all Collaboration Posts', () => {  
            //Cleanup - Delete all Collaboration Posts
