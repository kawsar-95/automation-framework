...
describe('LE - Welcome Tile Customization Background Image Configuration', function () {
    ...
    after(function () {
        ...
        //Navigate to Background Image edit options
    ...
    it('Welcome Tile - Background Image customization', () => {
        //Edit Welcome Tile in the Tile container
        cy.get(LEManageTemplateTiles.getContainerByIndex(1)).within(() => {
            LEManageTemplateTiles.getTileEditBtnByTileName(dashboardDetails.body)
        })
